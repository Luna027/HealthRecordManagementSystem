...
export default {
  ...
  methods:{
    ...
    delBatch(){
      let ids = this.multipleSelection.map(v =>v.id) //扁平化处理，[{},{}]=>[1,2]
...
<template>
  <div>
    <div style="margin: 10px 0">
      ...
      <el-input style="width: 200px" placeholder="请输入地址" suffix-icon="el-icon-search" class="ml-5" v-model="address"></el-input>
